...
export default function ProfileForm() {
  ...
  return (
      ...
      <AppContainer>
        ...
        <Field as={SelectStyle} name="goal" style={{ width: "350px", height: "35px" }}>
        ...
        <Field as={SelectStyle} name="activity" style={{ width: "350px", height: "35px" }}>
        ...
        <Field as={SelectStyle} name="gender" style={{ width: "350px", height: "35px" }}>
