export const appColors = {
  colors: {
    ...
    SECONDARY_COLOR_40: 'rgba(255, 255, 255, 0.4)',
    BLACK_COLOR: '#0f0f0f',
    ERROR_COLOR: '#e83636',
...
export const lightAppColors = {
  colors: {
    ...
    FATS_COLOR: '#F2D12A',
    CARBS_COLOR: '#DC191C',
    SECONDARY_COLOR: '#cdcd32',
    SECONDARY_COLOR_40: 'rgba(46, 46, 46, 0.4)',
    BLACK_COLOR: '#ffffff',
    ERROR_COLOR: '#e83636',
    ERROR_COLOR_HOVER: '#a60000',
    OK_COLOR: '#47f647',
    DISABLED_COLOR_LIGHT: '#5b5b5b',
    DISABLED_COLOR_DARK: '#5e5c5c',
  },
